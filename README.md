...
### Project overveiw 
This project is part of the Digital Literacy course at VIT Bhopal.The main goal of this Digital Literacy project is to learn digital skills like using online tools and building a professional digital presence.We also want to learn how to communicate and understand cyber safety, through this Digital Literacy project.As a Student Digital Ambassador this Digital Literacy project helps me guide my students to use digital platforms in a responsible and effective way.

### Repository Structure
•⁠  ⁠*⁠ Task-1-Presentation/ ⁠*: Contains the visual infographic designed on Canva explaining core digital literacy concepts.  
•⁠  ⁠*⁠ Task-2-Portfolio/ ⁠*: Contains proof of professional profile creation across GitHub, LinkedIn, and Kaggle.  
•⁠  ⁠*⁠ Task-3-Platforms/ ⁠*: Contains screenshots of Python coding practice on HackerRank and the backend setup of the Google Form & Sheet.  
•⁠  ⁠*⁠ Task-4-Email-Etiquette/ ⁠*: Contains drafts of professional academic and professional emails, alongside a Do's and Don'ts checklist for social media.  
•⁠  ⁠*⁠ Task-5-Cybercrime/ ⁠*: Contains a detailed case study on UPI payment fraud and an 8-point cybercrime prevention checklist.  
•⁠  ⁠*⁠ Project_Report.pdf ⁠*: The final compiled academic report detailing all reflections, methodologies, and write-ups for the above tasks. 

### Task3:- Google form link
https://docs.google.com/forms/d/e/1FAIpQLSdTwmNfFNZ6ClGl2GGRJ6GefFbLe86hBgDfPpJr-dC8mMoDjA/viewform?usp=sharing&ouid=110396712072287899765
